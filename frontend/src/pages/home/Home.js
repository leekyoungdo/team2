...
//   const bannerDogs = []; // bannerDogs 배열이 정의되어 있지 않아서 추가했습니다 -동욱
...
//         prevIndex < bannerDogs.length - 1 ? prevIndex + 1 : prevIndex
//       );
//     }
//   };

//   useEffect(() => {
//     const bannerDogs = bannerDogsRef.current.querySelectorAll('.bannerDog');
//     const bannerShowDogs =
//       bannerDogsRef.current.querySelector('.bannerShowDogs');

//     bannerDogs.forEach((bannerDog) => {
//       bannerDog.style.width = `${bannerShowDogs.clientWidth}px`;
//     });

//     bannerDogsRef.current.style.width = `${
//       bannerShowDogs.clientWidth * bannerDogs.length
//     }px`;
//   }, []);
...
//           {dogs.map((dog, index) => (
//             <div className="bannerDog" key={index}>
//               <img
//                 className="DogPic"
//                 src={dogpic}
//                 alt="강아지"
